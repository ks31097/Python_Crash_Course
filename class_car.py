"""Classes for representing cars with petrol and electric."""
...
class Car():
    ...
    def update_odometer(self, mileage, something):
        """Update car odometer."""
        ...
        print(f"Print something: {something}")
...
# my_new_car.update_odometer(23_500, 'time')
# my_new_car.read_odometer()
